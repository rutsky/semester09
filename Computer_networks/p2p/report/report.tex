...
\begin{itemize}
  ...
  При увеличении размера окна передачи, 
  с некоторого момента увеличение окна не улучшает скорость работы сети.
  ...
  \item Время передачи данных и количество посланных данных на построенной модели
